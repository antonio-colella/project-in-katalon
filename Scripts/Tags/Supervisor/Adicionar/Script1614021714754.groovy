...
KeywordUtil.markWarning("Infelizmente você não tem permissão para acessar esse conteúdo")
WebUI.click(findTestObject('Object Repository/Permissoes/button Ok Fechar mensagem'))
