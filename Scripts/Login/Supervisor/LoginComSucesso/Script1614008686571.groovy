...
if (var == true) {
	...
	WebUI.setText(findTestObject('Object Repository/Login/input Email'), GlobalVariable.supervisorEmail)

	KeywordUtil.markPassed('Passou: Digitou: ' + GlobalVariable.supervisorEmail + 'no campo email')
} else {
...
WebUI.setText(findTestObject('Object Repository/Login/input Senha'), GlobalVariable.supervisorSenha)
