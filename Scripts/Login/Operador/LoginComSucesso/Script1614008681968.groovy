...
if (var == true) {
	...
	WebUI.setText(findTestObject('Object Repository/Login/input Email'), GlobalVariable.operadorEmail)

	KeywordUtil.markPassed('Passou: Digitou: ' + GlobalVariable.operadorEmail + 'no campo email')
} else {
...
WebUI.setText(findTestObject('Object Repository/Login/input Senha'), GlobalVariable.operadorSenha)
